...
void calculate_metrics(){
	...
	//Average Queue Time
	printf("Average Queue Time: %f minutes/n " , ((float)(Bank.totalTimeInQueue/Bank.customersServiced))/2 );

	//Maximum Queue Time
	printf("Maximum Queue Time: %f minutes/n ", ((float)Bank.maxTimeInQueueCust)/2 );

	//Average Transaction Time
	printf("Average Transaction Time: %f minutes/n ", ((float)(Bank.totalTimeWithTellers/Bank.customersServiced))/2 );

	//Maximum Transaction Time
	printf("Maximum Transaction Time: %f minutes/n ", ((float)Bank.maxTimeInTransaction)/2 );

	//Average Teller Idle Time
	printf("Average Teller Idle Time: %f minutes/n ", ((float)Bank.totalTellerDowntime/3)/2 );

	//Longest Line
	printf("Longest Line: %f/n ", (float)Bank.maxNumInQueue );
